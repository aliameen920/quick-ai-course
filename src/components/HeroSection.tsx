...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full min-h-[90vh] py-8 md:py-16 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container px-4 md:px-6 flex flex-col items-center text-center gap-4 md:gap-8">
        {/* Video embedded at the top for immediate visibility */}
        <motion.div 
          initial="hidden"
          animate="visible"
        ...
        <motion.h1 
          ...
          variants={textAnimation}
          custom={2}
          className="font-heading text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-3xl"
        >
        ...
        <motion.p 
          ...
          variants={textAnimation}
          custom={3}
          className="max-w-[42rem] text-base md:text-lg text-muted-foreground font-light"
        >
        ...
        {/* Video trigger area - hidden since we show it directly */}
